...
public interface ProductService extends BaseService<Product, Long> {
	 ...
	 * @return 商品分页
	 */
	Page<Product> findPage(Area area,ProductCategory productCategory, Brand brand, Promotion promotion, List<Tag> tags, Map<Attribute, String> attributeValue, BigDecimal startPrice, BigDecimal endPrice, Boolean isMarketable, Boolean isList, Boolean isTop, Boolean isGift, Boolean isOutOfStock, Boolean isStockAlert, OrderType orderType, Pageable pageable);
	...
	public OrderResponder checkProduct(Member member, Product product);
