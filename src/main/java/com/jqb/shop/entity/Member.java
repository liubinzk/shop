...
import com.jqb.shop.interceptor.MemberInterceptor;
...
public class Member extends BaseEntity {
	...
	/** "身份信息"参数名称 */
	public static final String MOBILE_PRINCIPAL_ATTRIBUTE_NAME = MemberInterceptor.class.getName() + "_mobile.PRINCIPAL";
	...
	public void initRestEntiy(){
		...
		this.setReceivers(null);
		this.setPayments(null);
		this.setFavoriteProducts(null);
		this.setMemberRank(null);
		this.setDeposits(null);
		this.setCouponCodes(null);
		this.setReviews(null);
		this.setInMessages(null);
		this.setOutMessages(null);
		this.setArea(null);
	}
