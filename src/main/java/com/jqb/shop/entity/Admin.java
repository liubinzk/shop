...
public class Admin extends BaseEntity {
	...
	/** 收货地址 */
	private Set<AdminReceiver> receivers = new HashSet<AdminReceiver>();
	...
	public Set<AdminReceiver> getReceivers() {
		return receivers;
	}
	 ...
	 *            收货地址
	 */
	public void setReceivers(Set<AdminReceiver> receivers) {
