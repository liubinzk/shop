...
import com.jqb.shop.Setting.AccountLockType;
import com.jqb.shop.Setting.CaptchaType;
import com.jqb.shop.Setting.ConsultationAuthority;
import com.jqb.shop.Setting.ReviewAuthority;
import com.jqb.shop.Setting.RoundType;
import com.jqb.shop.Setting.StockAllocationTime;
import com.jqb.shop.Setting.WatermarkPosition;
import com.jqb.shop.service.CacheService;
import com.jqb.shop.service.FileService;
import com.jqb.shop.service.MailService;
...
public class SettingController extends BaseController {
	...
	public String update(Setting setting, MultipartFile watermarkImageFile, RedirectAttributes redirectAttributes) {
		...
		try {
			org.springframework.core.io.Resource resource = new ClassPathResource(CommonAttributes.JQBSHOP_PROPERTIES_PATH);
