...
public class SnDaoImpl implements SnDao, InitializingBean {
	...
	private HiloOptimizer settleAccountsHiloOptimizer;
	...
	@Value("${sn.settleAccounts.prefix}")
	private String settleAccountsPrefix;
	@Value("${sn.settleAccounts.maxLo}")
	private int settleAccountsMaxLo;
	...
	public void afterPropertiesSet() throws Exception {
		...
		settleAccountsHiloOptimizer= new HiloOptimizer(Type.settleAccounts, settleAccountsPrefix, settleAccountsMaxLo);
	}
	...
	public String generate(Type type) {
		...
		}else if (type == Type.settleAccounts) {
			return settleAccountsHiloOptimizer.generate();
		}
		return null;
	}
