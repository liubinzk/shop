...
<%!
	...
	public static final String DEMO_IMAGE_URL = "/storage/demo-image/3.0";
...
<title>系统提示 - Powered By JQB SHOP</title>
...
<body>
	<fieldset>
		<legend>系统提示</legend>
		<p>您无此访问权限！若您需要重新安装JQB SHOP程序，请删除/install/install_lock.conf文件！ [<a href="../index.html">进入首页</a>]</p>
		<p>
