...
<%
	...
	boolean isShopxxXmlCanWrite = isCanWrite(rootPath + "/WEB-INF/classes/jqbshop.xml");
	boolean isShopxxPropertiesWrite = isCanWrite(rootPath + "/WEB-INF/classes/jqbshop.properties");
...
<title>检查安装环境 - Powered By JQB SHOP</title>
...
<body>
	<div class="header">
		<div class="title">JQB SHOP 安装程序 - 环境检测</div>
	...
	<div class="body">
		...
		<div class="bodyRight">
			...
			<table>
				...
				<tr>
					<td>
						/WEB-INF/classes/jqbshop.properties
					</td>
					<td>
						可写
					</td>
	...
	<div class="footer">
		<p class="copyright">Copyright © 2014-2015 jingqubao.com All Rights Reserved.</p>
	</div>
</body>
</html>
