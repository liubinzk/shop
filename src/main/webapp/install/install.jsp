...
<title>JQB SHOP安装程序 - Powered By JQB SHOP</title>
...
<body>
	<div class="header">
		<div class="title">JQB SHOP 安装程序</div>
	...
	<div class="footer">
		<p class="copyright">Copyright © 2014-2015 shopxx.net All Rights Reserved.</p>
	</div>
	<%
	...
	<script type="text/javascript">
		$().ready(function() {
				...
				$.ajax({
					...
					success: function(data) {
						if (data.status == "success") {
							...
							$installMessage.html('<div id="installSuccess" class="installSuccess"><strong>恭喜您，JQB SHOP系统安装成功，请重新启动WEB服务器！<\/strong><span>基于安全考虑，请在安装成功后删除install目录<\/span><\/div>');
			...
			$complete.click( function() {
				alert("恭喜您,JQB SHOP系统安装成功，请重新启动WEB服务器！");
			});
