...
<title>${message("admin.role.edit")} - Powered By JQB SHOP</title>
			...
			<tr class="authorities">
				...
				<td>
					<span class="fieldSet">
						...
						<label>
							<input type="checkbox" name="authorities" value="admin:settleAccounts" [#if role.authorities?seq_contains("admin:settleAccounts")] checked="checked"[/#if] />${message("admin.role.settleAccounts")}
						</label>	
					</span>
				</td>
			</tr>
			...
			<tr class="authorities">
				...
				<td>
					<span class="fieldSet">
						...
						<label>
							<input type="checkbox" name="authorities" value="admin:commercial" [#if role.authorities?seq_contains("admin:commercial")] checked="checked"[/#if]/>${message("admin.main.admin.commercial")}
						</label>	
					</span>
				</td>
			</tr>
