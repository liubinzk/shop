...
<title>${message("admin.role.add")} - Powered By JQB SHOP</title>
			...
			<tr class="authorities">
				...
				<td>
					<span class="fieldSet">
						...
						<label>
							<input type="checkbox" name="authorities" value="admin:settleAccounts" />${message("admin.role.settleAccounts")}
						</label>	
					</span>
				</td>
			</tr>
			...
			<tr class="authorities">
				...
				<td>
					<span class="fieldSet">
						...
						<label>
							<input type="checkbox" name="authorities" value="admin:receiver" />${message("admin.main.admin.receiver")}
						</label>
						<label>
						...
						<label>
							<input type="checkbox" name="authorities" value="admin:commercial" />${message("admin.main.admin.commercial")}
						</label>	
					</span>
				</td>
			</tr>
