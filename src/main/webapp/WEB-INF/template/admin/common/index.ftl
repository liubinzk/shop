...
<title>${message("admin.index.title")} - Powered By JQB SHOP</title>
...
<body>
	...
	<table class="input">
		...
		<tr>
			...
			<td>
				<a href="http://www.jingqubao.com" target="_blank">http://www.jingqubao.com</a>
			</td>
			<th>
				${message("admin.index.bbs")}:
			</th>
			<td>
				<a href="http://bbs.jingqubao.com" target="_blank">http://bbs.jingqubao.com</a>
			</td>
		</tr>
		<tr>
			<td colspan="4">
