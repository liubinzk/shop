...
<title>${message("admin.main.title")} - Powered By JQB SHOP</title>
...
<body>
	...
	<table class="main">
		<tr>
			<th class="logo">
				<a href="main.jhtml">
					<img src="${base}/resources/admin/images/header_logo.gif" alt="JQB SHOP" />
				</a>
			</th>
			<th>
				<div id="nav" class="nav">
					<ul>
						...
						[/#list]
						<li>
							<a href="http://www.jingqubao.com" target="_blank">${message("admin.main.home")}</a>
						</li>
					</ul>
				</div>
				<div class="link">
					<a href="http://www.jingqubao.com" target="_blank">${message("admin.main.official")}</a>|
					<a href="http://bbs.jingqubao.com" target="_blank">${message("admin.main.bbs")}</a>|
					<a href="http://www.jingqubao.com/about.html" target="_blank">${message("admin.main.about")}</a>
				</div>
				<div class="link">
		...
		<tr>
			<td id="menu" class="menu">
				...
				<dl id="order">
					...
					[/@shiro.hasPermission]
					[@shiro.hasPermission name="admin:settleAccounts"]
						<dd>
							<a href="../settleAccounts/list.jhtml" target="iframe">商户结算</a>
						</dd>
					[/@shiro.hasPermission]
				</dl>
				<dl id="member">
				...
				<dl id="system">
					...
					[/@shiro.hasPermission]
					[@shiro.hasPermission name="admin:receiver"]
						<dd>
							<a href="../admin/receiver/list.jhtml" target="iframe">${message("admin.main.admin.receiver")}</a>
						</dd>
					[/@shiro.hasPermission]
					[@shiro.hasPermission name="admin:commercial"]
						<dd>
							<a href="../commercial/list.jhtml" target="iframe">${message("admin.main.admin.commercial")}</a>
						</dd>
					[/@shiro.hasPermission]					
