...
<title>${message("admin.product.add")} - Powered By JQB SHOP</title>
...
$().ready(function() {
  ...
  function changeImagePath(){
  	var value=document.getElementById("imageId").value;
  	if (value &&  (value.indexOf("http")>-1)) 
	{ 
		 var index = value.indexOf("/upload");
		 var sub_string = value.substring(index);
		 document.getElementById("imageId").value=sub_string;
	} 
	setTimeout(changeImagePath,500);
  }
  setTimeout(changeImagePath,500);
</script>
</head>
<body>
	...
	<form id="inputForm" action="save.jhtml" method="post" enctype="multipart/form-data">
		...
		<table class="input tabContent">
			...
			<tr>
				<th>
						<span class="requiredField">*</span>商户：
					</th>
					<td>
						<select name="commercialId">
							<option value="">${message("admin.common.choose")}</option>
							[#list commercials as commercial]
								<option value="${commercial.id}">
									${commercial.name}(${commercial.introduction})
								</option>
							[/#list]
						</select>
					</td>
            ...
            <tr>
                <th>
                    <span class="requiredField">*</span>${message("admin.area.add")}:
                </th>
                <td>
					<span class="fieldSet">
			...
			<tr>
				...
				<td>
					<span class="fieldSet">
						<input type="text" id="imageId" name="image" class="text" maxlength="200" title="${message("admin.product.imageTitle")}"/>
            ...
            <tr>
                ...
                <td>
                    <input type="text" name="sequenceNum" class="text" value="${product.sequenceNum}" maxlength="9" />
                </td>
            </tr>
            <tr>
                <th>
				${message("admin.product.setting.isPayShipping")}:
                </th>
                <td>
                    <label>
                        <input type="checkbox" name="isPayShipping" value="true"[#if product.isPayShipping] checked="checked"[/#if] />${message("admin.product.setting.isPayShipping")}
                        <input type="hidden" name="_isPayShipping" value="false" />
                    </label>
                </td>
            </tr>
            <tr>
                <th>
				${message("admin.product.setting.freeShipping")}:
                </th>
                <td>
                    <input type="text" name="shippingPrice" class="text" value="${product.shippingPrice}" maxlength="8" />
                </td>
            </tr>
            <tr>
                <th>
				${message("admin.product.setting.isRestriction")}:
                </th>
                <td>
                    <label>
                        <input type="checkbox" name="isRestriction" value="true"[#if product.isRestriction] checked="checked"[/#if] />${message("admin.product.setting.isRestriction")}
                        <input type="hidden" name="_isRestriction" value="false" />
                    </label>
                </td>
            </tr>
            <tr>
                <th>
				${message("admin.product.setting.restriction")}:
                </th>
                <td>
                    <input type="text" name="restrictionNum" class="text" value="${product.restrictionNum}" maxlength="8" />
                </td>
            </tr>
			<tr>
				<th>
