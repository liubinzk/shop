...
<title>${message("admin.product.edit")} - Powered By JQB SHOP</title>
	...
	<form id="inputForm" action="update.jhtml" method="post" enctype="multipart/form-data">
		...
		<table class="input tabContent">
					...
					<td>
						<select name="commercialId">
							...
							[#list commercials as commercial]
								<option value="${commercial.id}" [#if commercial == product.commercial] selected="selected"[/#if]>
			...
			<tr>
				...
				<td>
				<span class="fieldSet">
					<input type="hidden" id="areaId" name="areaId" value="${(product.area.id)!}" treePath="${(product.area.treePath)!}" />
				</span>
				</td>
			</tr>
			<tr>
			...
			<tr>
				<td>
					<table id="specificationProductTable" class="input">
						...
						[/#if]
						[#list product.productSiblings as specificationProduct]
							<tr>
								<td>
									&nbsp;
