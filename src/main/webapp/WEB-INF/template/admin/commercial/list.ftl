...
<body>
	<div class="path">
		<a href="${base}/admin/common/index.jhtml">${message("admin.path.index")}</a> &raquo; 商户列表 <span>(${message("admin.page.total", page.total)})</span>
	</div>
	<form id="listForm" action="list.jhtml" method="get">
		<div class="bar">
			...
			<table id="listTable" class="list">
					...
					[#list page.content as commercial]
						<tr[#if !receiver_has_next] class="last"[/#if]>
							<td>
								<input type="checkbox" name="ids" value="${commercial.id}" />
							</td>
							<td>
							...
							<td>
								<a href="edit.jhtml?id=${commercial.id}">[编辑]</a>
							</td>
						</tr>
					[/#list]
				</table>
