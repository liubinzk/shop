...
<title>${message("admin.order.list")} - Powered By JQB SHOP</title>
	...
	<form id="listForm" action="list.jhtml" method="get">
			...
			<div class="menuWrap">
				...
				<div class="popupMenu">
					<ul id="searchPropertyOption">
						...
						<li>
							<a href="javascript:;"[#if page.searchProperty == "customerOrder.sn"] class="current"[/#if] val="customerOrder.sn">虚拟编号</a>
						</li>
					</ul>
				</div>
			</div>
		...
		<table id="listTable" class="list">
			<tr>
				...
				<th>
					<a href="javascript:;" class="sort" name="order.commercial.name">商户</a>
				</th>
				<th>
			...
			[#list page.content as order]
				<tr>
					<td>
						<input type="checkbox" name="ids" value="${order.id}" />${order.id}
					</td>
					<td>
						${order.sn}
					</td>
					<td>
						${order.customerOrder.sn}
					</td>
					<td>
