...
<title>${message("admin.ad.edit")} - Powered By JQB SHOP</title>
	...
	<form id="inputForm" action="update.jhtml" method="post">
		...
		<table class="input">
            ...
            <tr>
                ...
                <td>
                    <select id="promotionIds" name="promotionIds">
					[#list promotions as promotion]
                        <option value="${promotion.id}"[#if promotion.id == ad.promotionIds] selected="selected"[/#if]>${promotion.name}</option>
					[/#list]
                    </select>
                </td>
            </tr>
