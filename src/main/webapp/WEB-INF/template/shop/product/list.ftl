...
[#if productCategory??]
	[@seo type = "productList"]
		<title>[#if productCategory.seoTitle??]${productCategory.seoTitle}[#elseif seo.title??][@seo.title?interpret /][/#if][#if systemShowPowered] - Powered By JQB SHOP[/#if]</title>
	...
	[/@seo]
[#else]
	<title>${message("shop.product.title")}[#if systemShowPowered] - Powered By JQB SHOP[/#if]</title>
	<meta name="author" content="JQB SHOP Team" />
	<meta name="copyright" content="JQB SHOP" />
[/#if]
