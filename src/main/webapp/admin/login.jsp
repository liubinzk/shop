...
<%@page import="com.jqb.shop.Setting"%>
<%@page import="com.jqb.shop.util.SettingUtils"%>
<%@page import="com.jqb.shop.util.SpringUtils"%>
<%@page import="com.jqb.shop.Setting.CaptchaType"%>
<%@page import="com.jqb.shop.Setting.AccountLockType"%>
<%@page import="com.jqb.shop.service.RSAService"%>
...
%>
<title><%=SpringUtils.getMessage("admin.login.title")%> - Powered By JQB SHOP</title>
...
<%} else {%>
<title>提示信息 - Powered By JQB SHOP</title>
<meta http-equiv="expires" content="0" />
<meta http-equiv="Pragma" content="no-cache" />
<meta http-equiv="Cache-Control" content="no-cache" />
<meta name="author" content="JQB SHOP Team" />
				...
				<table>
					<tr>
						<td width="190" rowspan="2" align="center" valign="bottom">
							<img src="<%=base%>/resources/admin/images/login_logo.gif" alt="JQB SHOP" />
						</td>
						<th>
					...
					<tr>
						...
						<td>
							<input type="button" class="homeButton" value="" onclick="location.href='<%=base%>/admin/'" /><input type="submit" class="loginButton" value="<%=SpringUtils.getMessage("admin.login.login")%>" />
						</td>
					</tr>
				</table>
				<div class="powered">COPYRIGHT © 2014-2015 SHOPXX.NET ALL RIGHTS RESERVED.</div>
				<div class="link">
					<a href="<%=base%>/"><%=SpringUtils.getMessage("admin.login.home")%></a> |
					<a href="http://www.jingqubao.com"><%=SpringUtils.getMessage("admin.login.official")%></a> |
					<a href="http://bbs.jingqubao.com"><%=SpringUtils.getMessage("admin.login.bbs")%></a> |
					<a href="http://www.jingqubao.com/about.html"><%=SpringUtils.getMessage("admin.login.about")%></a> |
					<a href="http://www.jingqubao.com/contact.html"><%=SpringUtils.getMessage("admin.login.contact")%></a> |
					<a href="http://www.jingqubao.com/license.html"><%=SpringUtils.getMessage("admin.login.license")%></a>
				</div>
			</form>
		</div>
	<%} else {%>
		<fieldset>
			...
			<p>请检查JQB SHOP程序是否已正确安装 [<a href="<%=base%>/install/">点击此处进行安装</a>]</p>
			<p>
				<strong>提示: JQB SHOP安装完成后必须重新启动WEB服务器</strong>
			</p>
		</fieldset>
	<%}%>
</body>
